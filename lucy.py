...
"""
============================================================
  🤖  RWBot — Robotwala RAG-Powered Speech-to-Speech Chatbot
...
if not _ESPEAK_AVAILABLE:
    logging.getLogger("rwbot").warning(
...
logger = logging.getLogger("rwbot")
...
# ── RAG settings ──────────────────────────────────────────
PDF_PATH_EN   = os.getenv("PDF_PATH_EN", "/home/pi/Desktop/Robotwala/robotwala_english_details.pdf")
PDF_PATH_HI   = os.getenv("PDF_PATH_HI", "/home/pi/Desktop/Robotwala/robotwala_hindi_details.pdf")
...
LTM_PATH       = os.getenv("LTM_PATH", os.path.join(os.path.dirname(os.path.abspath(__file__)), "rwbot_memory.json"))
LTM_MAX_FACTS  = 50
LTM_RETRIEVE_K = 4
...
# ── System prompts ────────────────────────────────────────
_BASE_EN = (
    "Your name is RWBot. You are the official AI assistant and virtual "
    "representative of Robotwala, a leading AI, Robotics, Drone, 3D "
    "Printing, Coding, and STEM education institute and innovation "
    "startup headquartered at 201, Apollo Avenue, Old Palasia, Indore, "
    "Madhya Pradesh, India. "
    "Robotwala's tagline is 'Igniting Young Minds for Tomorrow's Tech.' "
    "It was co-founded by Prof. Imran Baig (Co-Founder), with Dr. "
    "Zaheeruddin Babar serving as Investor and Mentor. "
    "Robotwala has launched 25+ robots, inspired 200+ schools and 50+ "
    "colleges, and trained over 200,000 students. Its offerings include "
    "robotics and AI/ML education, drone technology training, 3D "
    "printing, coding classes, school and college lab setups, "
    "internships, and a franchise programme (#RevolutionByRobotwala). "
    ...
    "and politely redirect the conversation toward Robotwala, "
...
_BASE_HI = (
    "Aapka naam RWBot hai. Aap Robotwala ke official AI assistant aur "
    "virtual representative hain. Robotwala Indore, Madhya Pradesh, "
    "India mein sthit ek agrani AI, Robotics, Drone, 3D Printing, "
    "Coding aur STEM shiksha sanstha aur innovation startup hai, jiska "
    "pata hai 201, Apollo Avenue, Old Palasia, Indore hai. "
    "Robotwala ki tagline hai 'Igniting Young Minds for Tomorrow's "
    "Tech.' Ismein Prof. Imran Baig Co-Founder hain, aur Dr. "
    "Zaheeruddin Babar Investor aur Mentor hain. "
    "Robotwala ne 25 se zyada robots launch kiye hain, 200 se zyada "
    "schools aur 50 se zyada colleges ko inspire kiya hai, aur 2 lakh "
    "se zyada students ko train kiya hai. Iske offerings mein robotics "
    "aur AI/ML education, drone technology training, 3D printing, "
    "coding classes, school aur college lab setup, internships, aur "
    "franchise programme (#RevolutionByRobotwala) shamil hain. "
    ...
    "Robotwala ki taraf le jaayein, iski strengths highlight "
...
def is_internet_available(host: str = "8.8.8.8", port: int = 53, timeout: float = 2.0) -> bool:
    """
    Quick TCP probe. FIX-A1: uses a scoped per-socket timeout (not
...
def main() -> None:
    try:
        ...
        speak("Hello! I am RWBot, Robotwala's AI assistant. ", lang="hi")
